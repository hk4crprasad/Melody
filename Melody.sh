...
sleep 2.0 
clear
echo "ZWNobyAiICIKZWNobyAiICIKZWNobyAiICIKZWNobyAiICIKZWNobyAiICIKZWNobyAiICAgICAgICAgICAgICJFWElUIEZST00gVEVSTVVYIEFORCBSRSBPUEVOIElUIEFGVEVSIDUgU0VDT05EUyB8bG9sY2F0IAplY2hvICIgIgplY2hvICIgIg==" | base64 -d | bash
sleep 3.0
cd $HOME
