...
yellow='\e[1;33m'
###################################
apt update ; apt upgrade -y ; apt install python -y
clear
z="
...
clear
z="
";Cz=' "  ';Qz='NDS ';Sz='cat';Jz=' AND';Ez='   "';Dz='    ';Hz='M TE';Bz=' " "';Pz='SECO';Oz='R 5 ';Rz='|lol';Kz=' RE ';Az='echo';Gz=' FRO';Iz='RMUX';Fz='EXIT';Nz='AFTE';Mz=' IT ';Lz='OPEN';
eval "$Az$Bz$z$Az$Bz$z$Az$Bz$z$Az$Bz$z$Az$Bz$z$Az$Cz$Dz$Dz$Ez$Fz$Gz$Hz$Iz$Jz$Kz$Lz$Mz$Nz$Oz$Pz$Qz$Rz$Sz$z$Az$Bz$z$Az$Bz"
sleep 3.0
cd $HOME
